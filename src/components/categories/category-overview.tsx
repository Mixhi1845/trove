  ...
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
      <CategoryCard title="Productivity">
        <CategoryItem toolname="Weather" route="/productivity/weather" />
        <CategoryItem
          toolname="DeepL Translator"
          route="/productivity/translator"
        />
        <CategoryItem
      ...
      <CategoryCard title="Data">
        <CategoryItem toolname="Emojis" badge="Symbols" route="/data/emoji" />
        <CategoryItem
          toolname="Scientific"
          badge="Symbols"
          route="/data/symbols"
